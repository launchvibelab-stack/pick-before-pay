...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const headers: {
      ...
      {
        source: "/:path(favicon.ico|favicon-p.ico|favicon-p2.ico|icon.png|icon-p.png|icon-p2.png|apple-touch-icon.png|apple-touch-icon-p.png|apple-touch-icon-p2.png|logo.png)",
